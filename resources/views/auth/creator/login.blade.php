    ...
    <div class="login-container">
        <div class="poster-section">
            <div class="poster-content">
                ...
                <h2>Welcome<br>Back, Creator!</h2>
                <p>Your audience is waiting. Continue building your legacy and inspiring your community.</p>
                <div class="features">
        ...
        <div class="form-content">
            ...
            <div id="loginForm">
                ...
                <form action="{{route('auth.creator.login.post')}}" method="POST">
                    @csrf
