...
<body>
    <div class="login-container">
        ...
        <div class="form-content">
            <!-- Login Form -->
            <div id="loginForm">
                <h2 class="mt-3 d-none">Sign Up to your account</h2>
                <form action="{{ route('auth.user.signup.post') }}" method="POST">
                    @csrf
                ...
                <div class="toggle-form">
                    Already have an account? <a href="{{ route('auth.user.login.view') }}">Log in</a>
                </div>
